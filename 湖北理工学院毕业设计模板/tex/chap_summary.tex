...
\newtheorem*{axiomofchoice1}{Axiom of choice1}
\begin{axiomofchoice1}
...
\newtheorem{observation1}{Observation1}[chapter]
\begin{observation1}
...
\newtheorem{observationvar21}[observation]{Observationvar21}
\begin{observationvar21}
  Suppose a partially ordered set $P$ has the property
  that every chain has an upper bound in $P$. Then the
  set $P$ contains at least one maximal element.
\end{observationvar21}
\begin{proof}[A concise proof]
  Obvious.
\end{proof}
